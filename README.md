...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/606239fba69c520017710f3a
...
To start editing your site, you can use the Sanity interface at https://erida-psicologia-239fb.sanity.studio/.
...
Generated at `2021-03-29T20:36:40.765Z` by Stackbit version `0.3.50`.